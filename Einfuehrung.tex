...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\subcaption[Schematische Darstellung des \acrshort{EQO2}]{Schematische Darstellung des \gls{EQO2}; Das Verhältnis aus der \gls{VE} und der \gls{VO2} wird gegenüber der Zeit oder der Leistung \gls{WL} geplottet}
		\label{subpic:pic6}
	\end{subfigure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\subcaption[Schematische Darstellung des \acrshort{EQCO2}]{Schematische Darstellung des \acrshort{EQCO2}; Das Verhältnis aus der \acrshort{VE} und der \acrshort{VCO2} wird gegenüber der Zeit oder Leistung \gls{WL} geplottet}
		\label{subpic:pic7}
	\end{subfigure}%
	\hfil
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\subcaption[Schematische Darstellung der \acrshort{VE} relativ zur \acrshort{VCO2}]{Schematische Darstellung des grafischen Vergleichs der \gls{VE} relativ zur \gls{VCO2}; Analogie zum V-Slope}
		\label{subpic:pic8}
	\end{subfigure}

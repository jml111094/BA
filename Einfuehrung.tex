...
%
\begin{flalign}
\dot{V}O_2 \text{ in \si{\litre\per\minute}} &= \dot{V}E * (FIO_2 - FEO_2)
\label{eq:formel6}\\[1em]
\dot{V}CO_2 \text{ in \si{\litre\per\minute}} &= \dot{V}E * FECO_2
\label{eq:formel7}
\end{flalign}
%
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\subcaption[Schematische Darstellung des \acrshort{EQO2}]{Schematische Darstellung des \gls{EQO2}; Das Verhältnis der \gls{VE} zur \gls{VO2} gegenüber der Zeit oder Leistung \acrshort{WL}}
		\label{subpic:pic6}
	\end{subfigure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\subcaption[Schematische Darstellung des \acrshort{EQCO2}]{Schematische Darstellung des \acrshort{EQCO2}; Das Verhältnis der \acrshort{VE} zur \acrshort{VCO2} gegenüber der Zeit oder Leistung \gls{WL}}
		\label{subpic:pic7}
	\end{subfigure}%
	\hfil
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\subcaption[Schematische Darstellung der \acrshort{VE} zur \acrshort{VCO2}]{Schematische Darstellung des grafischen Vergleichs der \gls{VE} relativ zur \gls{VCO2}; Analogie zum V-Slope}
		\label{subpic:pic8}
	\end{subfigure}

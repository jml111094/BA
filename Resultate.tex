...
\begin{figure}[H]
	...
	\begin{subfigure}[c]{0.45\textwidth}
		...
		\includegraphics[scale=0.73]{Bilder/eqo2_net}
			\subcaption[Vergleich der VT1-Bestimmungen durch das \acs{EQO2}]{Vergleich der VT1-Bestimmungen durch das \acs{EQO2} zwischen Ratern und Software; Intervall: \SIrange{0}{180}{\per\minute}}
			\label{subpic:pic2}
	\end{subfigure}
...
Abb. \ref{pic:pic24} zeigt das Diagramm für die \acs{EQO2}-Methode mit den Differenzen zwischen Ratern und Software. Dort beträgt diese im Mittel \SI{7,98}{\per\minute} bei einer \acs{SD} von ebenfalls $\pm$14 \si{\per\minute}.
...
\begin{figure}[H]
	...
	\begin{subfigure}[c]{0.45\textwidth}
		...
		\subcaption[Vergleich der VT2-Bestimmungen durch das \acs{EQCO2}]{Vergleich der VT2-Bestimmungen durch das \acs{EQCO2} zwischen Ratern und Software; Intervall: \SIrange{0}{250}{\per\minute}}
		\label{subpic:pic3}
	\end{subfigure}%
	\hfil
	\begin{subfigure}[c]{0.45\textwidth}
		...
		\subcaption[Vergleich der VT2-Bestimmungen durch \acs{VE}/\acs{VCO2}]{Vergleich der VT2-Bestimmungen durch \acs{VE}/\acs{VCO2} zwischen Ratern und Software; Intervall: \SIrange{0}{250}{\per\minute}}
		\label{subpic:pic4}
	\end{subfigure}
